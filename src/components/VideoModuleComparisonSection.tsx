...
const pillars = [
  {
    ...
    description:
      "Transforme o NexoImob AI em plataforma de criativo + copy + vídeo, aumentando ticket médio por corretor e por imobiliária.",
    icon: Sparkles,
  },
  {
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center mb-14">
          ...
          <p className="text-lg text-muted-foreground">
            O iMOVIE provou a demanda. O NexoImob AI pode capturar esse mercado com uma oferta mais forte: vídeo,
        ...
        <div className="grid lg:grid-cols-[1.2fr,0.8fr] gap-6">
          <div className="rounded-3xl border border-border/60 bg-card p-6 shadow-soft overflow-hidden">
            <div className="mb-5">
              ...
              <h3 className="font-display text-2xl font-bold text-foreground mt-2">iMOVIE vs NexoImob AI com módulo de vídeo</h3>
            </div>
            ...
            <div className="overflow-hidden rounded-2xl border border-border/60">
              <div className="grid grid-cols-[0.9fr,1fr,1fr] bg-muted/60 text-sm font-semibold text-foreground">
                ...
                <div className="p-4 border-l border-border/60 bg-accent/10 text-accent">NexoImob AI</div>
              </div>

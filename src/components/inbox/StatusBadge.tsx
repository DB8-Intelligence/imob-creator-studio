...
const statusConfig: Record<PropertyStatus, { label: string; className: string }> = {
  pending: { label: "Novo", className: "bg-amber-500/15 text-amber-700 border-amber-500/30" },
  editing: { label: "Em edição", className: "bg-blue-500/15 text-blue-700 border-blue-500/30" },
  approved: { label: "Aprovado", className: "bg-emerald-500/15 text-emerald-700 border-emerald-500/30" },
  published: { label: "Postado", className: "bg-violet-500/15 text-violet-700 border-violet-500/30" },

...
const THEME_CARDS: ThemeCard[] = [
  ...
  {
    id: "capital", label: "Capital", description: "Tradicional, vermelho, portal completo",
    longDescription: "Portal imobiliario tradicional com busca em abas, catalogo amplo e SEO. Ideal para corretores com muitos imoveis.",
    icon: "🏠", gradient: "linear-gradient(135deg, #002E5E, #CC0000)", color: "#CC0000",
    features: ["Busca em abas", "Navy + vermelho", "Portal completo"],
    isNew: true, isPremium: false, category: "Tradicional",
  },
  {
    id: "horizonte", label: "Horizonte", description: "Corporativo moderno, azul + laranja",
    longDescription: "Portal corporativo clean para imobiliarias regionais. Busca em abas, tags por bairro, servicos em destaque e foco em conversao.",
    icon: "☀️", gradient: "linear-gradient(135deg, #1E3A5F, #F39200)", color: "#F39200",
    features: ["Corporativo clean", "Azul + laranja", "Tags de bairro"],
    isNew: true, isPremium: false, category: "Corporativo",
  },
  {
    id: "prisma", label: "Prisma", description: "Minimalista, navy + branco, 18 categorias",
    longDescription: "Site minimalista com hero clean, busca em 3 modos (principal, codigo, avancada), grid de 18 categorias e preco em destaque. Ideal para portais de medio porte com muitas categorias.",
    icon: "✨", gradient: "linear-gradient(135deg, #0F172A, #3B82F6)", color: "#3B82F6",
    features: ["Minimalista clean", "18 categorias", "Preco destacado"],
    isNew: true, isPremium: false, category: "Moderno",
  },
  {
    id: "eixo", label: "Eixo", description: "Regional navy + verde, precos tricolor",
    longDescription: "Portal regional com abas categoria (Imoveis, Empreendimentos, Condominios), CTAs em verde e precos coloridos por finalidade (venda=vermelho, locacao=azul, temporada=verde). Ideal para multi-canal.",
    icon: "🎯", gradient: "linear-gradient(135deg, #1E40AF, #10B981)", color: "#10B981",
    features: ["Multi-finalidade", "Precos tricolor", "Abas categoria"],
    isNew: true, isPremium: false, category: "Regional",
  },
  {
    id: "vitrine", label: "Vitrine", description: "Catalogo amplo, 16 categorias + chatbot",
    longDescription: "Portal catalogo com multiplas secoes (destaques, selecionados, temporada), 16 categorias navegaveis, 6 servicos e chatbot Corretor Online. Ideal para imobiliarias com volume grande de anuncios.",
    icon: "🗂️", gradient: "linear-gradient(135deg, #0066CC, #059669)", color: "#0066CC",
    features: ["Catalogo amplo", "16 categorias", "Chatbot integrado"],
    isNew: true, isPremium: false, category: "Catalogo",
  },
  {
    id: "onix", label: "Onix", description: "Boutique luxo, monocromatico preto + dourado",
    longDescription: "Tema boutique premium para corretores de alto padrao. Monocromatico preto, branco e dourado discreto, tipografia leve, espacamento generoso, sem sombras pesadas. Refinamento e discricao.",
    icon: "◆", gradient: "linear-gradient(135deg, #1A1A1A, #B8860B)", color: "#1A1A1A",
    features: ["Boutique premium", "Monocromatico", "Tipografia leve"],
    isNew: true, isPremium: true, category: "Luxo",
  },
  {
    id: "farol", label: "Farol", description: "Regional ciano + teal, chips de categoria",
    longDescription: "Portal corporativo regional com busca em 3 modos (principal/codigo/avancada), chips de categoria rapida (Empreendimentos/Condominios/Lancamentos), 3 secoes de imoveis e overlay hover com Ver imovel. Ciano puro + teal no preco.",
    icon: "🗼", gradient: "linear-gradient(135deg, #0099CC, #0D9488)", color: "#0099CC",
    features: ["Ciano + teal", "Chips de categoria", "3 modos de busca"],
    isNew: true, isPremium: false, category: "Regional",
  },
  {
    id: "aurora", label: "Aurora", description: "Luminoso navy + ambar, preco overlay na foto",
    longDescription: "Tema moderno com hero em slider, cards com preco em overlay na foto (gradient escuro no bottom) e 6 servicos com icones coloridos. Navy profundo + ambar dourado. Ideal para corretores que querem visual moderno e destaque no preco.",
    icon: "✨", gradient: "linear-gradient(135deg, #1A3A52, #F59E0B)", color: "#1A3A52",
    features: ["Preco em overlay", "Hero slider", "Icones coloridos"],
    isNew: true, isPremium: false, category: "Moderno",
  },
  {
    id: "sereno", label: "Sereno", description: "Wellness verde + areia, refugio/natureza",
    longDescription: "Tema wellness para corretores que valorizam bem-estar e natureza. Verde esmeralda + areia quente, cantos generosamente arredondados (rounded-3xl), blobs decorativos, icones de natureza (folhas, sol, arvores), tags de estilo de vida. Ideal para chacaras, imoveis com area verde e refugios.",
    icon: "🌿", gradient: "linear-gradient(135deg, #065F46, #D4A574)", color: "#065F46",
    features: ["Wellness/natureza", "Rounded generoso", "Tags estilo de vida"],
    isNew: true, isPremium: false, category: "Wellness",
  },
  {
    id: "portico", label: "Portico", description: "Portal marketplace, azul royal + hero minimo",
    longDescription: "Tema marketplace com hero ultra-minimalista (fundo branco puro, busca centralizada), grade densa de 4 colunas, 15 categorias, 2 cards de servico (Anunciar/Financiar) e footer 2 colunas enxuto. Ideal para imobiliarias que querem parecer portal de acesso rapido.",
    icon: "🚪", gradient: "linear-gradient(135deg, #1D4ED8, #64748B)", color: "#1D4ED8",
    features: ["Hero ultra-min", "Grade 4 cols densa", "15 categorias"],
    isNew: true, isPremium: false, category: "Portal",
  },
];

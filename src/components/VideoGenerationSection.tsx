...
import { ArrowRight, Upload, Sliders, Download, Zap, Clock, Film, Star } from "lucide-react";
...
const benefits = [
  {
    icon: Clock,
    title: "Velocidade",
    description: "Vídeo pronto em menos de 3 minutos. Sem editor, sem equipe de filmagem.",
  },
  {
    icon: Film,
      ...
      <div className="container mx-auto px-6 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-primary-foreground mb-6">
            Transforme fotos de imóveis em{" "}
            <span className="text-gradient">vídeos cinematográficos</span>
          </h2>
          <p className="text-primary-foreground/70 text-lg">
            Agora dentro do ImobCreator AI: gere vídeos profissionais em 4K com IA para Reels, YouTube e Feed — sem equipe, sem edição, em menos de 3 minutos.
          </p>
        </div>

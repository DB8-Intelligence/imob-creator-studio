      ...
      <div className="container mx-auto px-6 relative">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-primary-foreground/70 text-lg">
            Agora dentro do NexoImob AI: gere vídeos profissionais em 4K para Reels, YouTube e Feed — sem equipe, sem edição e com possibilidade de vender como add-on para seus clientes.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1fr,0.9fr] gap-6 mb-16">
          <div className="rounded-3xl border border-primary-foreground/10 bg-primary-foreground/5 p-6 backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-display text-2xl font-bold text-primary-foreground">Complemento ideal do NexoImob AI</h3>
            </div>

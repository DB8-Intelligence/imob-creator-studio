...
export const AI_ENGINES: Record<AIEngineId, AIEngineDefinition> = {
  ...
  image_restoration: {
    ...
    strengths:     ["mobiliar ambientes", "decoração", "restauração de imagem"],
    plan_required: "standard",
    credit_cost:   2,
    status:        "active",
    badge:         "Exclusivo",
...
export const USE_CASES: Record<UseCaseId, UseCaseDefinition> = {
  ...
  mobiliar_ambiente: {
    ...
    icon:           "🛋️",
    engines:        ["image_restoration"],
    default_engine: "image_restoration",
...
export const USE_CASE_ROUTES: Partial<Record<UseCaseId, string>> = {
  ...
  mobiliar_ambiente:    "/image-restoration",

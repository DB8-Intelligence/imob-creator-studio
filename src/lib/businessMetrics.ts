...
export const RETARGETING_AUDIENCES: RetargetingAudience[] = [
  {
    ...
    adAngles: [
      {
        format:   "reels",
        headline: "Voce viu o NexoImob AI. Ainda nao testou?",
      ...
      },
      {
        ...
        body:     "Mais de 18.000 corretores ja criaram posts profissionais com NexoImob AI. Voce estava no site mas nao testou. O que falta?",
      ...
      },
      {
        ...
        body:     "Voce visitou o NexoImob AI. Sabia que pode testar sem pagar nada? 10 criativos gratis para voce ver o resultado antes de decidir.",
        cta:      "Começar grátis",
        angle:    "objection",
      },
    ],
    ...
    adAngles: [
      {
        ...
        body:     "Voce criou sua conta no NexoImob AI mas ainda nao gerou seu primeiro post. Leva 3 minutos. Tente agora — os resultados vao te surpreender.",
      ...
      },
      {
        ...
        body:     "Isso e o que corretores dizem apos gerar o primeiro criativo com NexoImob AI. Voce tem a conta — falta o primeiro post. Cria agora?",
        cta:      "Criar agora",
        angle:    "social_proof",
      },
    ],
    ...
    adAngles: [
      {
        ...
        body:     "Voce ja usou o NexoImob AI e sabe que funciona. Os creditos do trial sao limitados — com o plano pago voce tem acesso completo e continuo para todos os seus imoveis.",
      ...
      },
      {
        ...
        body:     "Corretores que postam com consistencia vendem mais rapido. O NexoImob AI custa menos do que o comissionamento de 1 visita. Faca a conta.",
        cta:      "Assinar agora",
        angle:    "benefit",
      },
      {
        ...
        body:     "'O NexoImob AI custou R$97 e me gerou 3 visitas novas em 1 semana. O custo se paga sozinho.' Teste de graca acabou? Assine e continue crescendo.",
        cta:      "Garantir meu plano",
        angle:    "social_proof",
      },
      {
        format:   "search",
        headline: "NexoImob AI — Continue usando",
        body:     "Você já experimentou. Seus créditos estão acabando. Assine o plano e continue criando posts profissionais ilimitados.",
        cta:      "Assinar NexoImob AI",
        angle:    "urgency",
      },
    ],
  },
...
export const HIGH_PERF_CREATIVES: CreativeSpec[] = [
  {
    ...
    body:        "Sem Canva, sem designer, sem espera. NexoImob AI faz tudo pela IA enquanto voce atende o proximo cliente.",
    cta:         "Testar grátis",
    hooks: [
  ...
  },
  {
    ...
    body:        "A diferenca entre foto no celular e post profissional nao e designer — e NexoImob AI. Cria o seu agora.",
    cta:         "Criar meu primeiro post",
    hooks: [
    ...
    productionNote: "Usar foto real de imovel do portfolio (pedir permissao ao usuario ou usar imovel proprio). Resultado gerado pelo proprio NexoImob AI. Legenda 'Vendido em X dias' aumenta conversao significativamente.",
    expectedCtr: "2.5–4.5%",
  ...
  },
  {
    ...
    hooks: [
      "Voce esta usando 3 ferramentas para fazer o que o NexoImob AI faz em 1.",
  ...
  },
  {
    ...
    structure: [
      ...
      "10–25s: Resultado: 'Depois do NexoImob AI, gerou X posts em Y minutos, resultado Z'",
      "25–35s: Prova visual: mostrar post/video criado pelo NexoImob AI",
    ...
    body:        "Ana Paula F., gerente de marketing da RE/MAX, usou o NexoImob AI para criar videos cinematicos dos imoveis. Resultado: 3x mais visualizacoes nos reels e mais visitas qualificadas.",

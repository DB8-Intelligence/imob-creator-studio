...
const Auth = () => {
  ...
  const handleGithubSignIn = async () => {
    ...
    try {
      ...
      if (error) {
        toast({ variant: "destructive", title: "Erro ao entrar com GitHub", description: error.message });
      }
    } catch (e: unknown) {
      toast({ variant: "destructive", title: "Erro ao entrar com GitHub", description: e instanceof Error ? e.message : "Tente novamente" });
    } finally {
